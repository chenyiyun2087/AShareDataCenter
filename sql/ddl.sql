...
CREATE TABLE IF NOT EXISTS ods_stk_factor (
  ...
  amount DECIMAL(20,4) NULL,
  adj_factor DECIMAL(20,4) NULL,
  open_hfq DECIMAL(20,4) NULL,
  open_qfq DECIMAL(20,4) NULL,
  close_hfq DECIMAL(20,4) NULL,
  close_qfq DECIMAL(20,4) NULL,
  high_hfq DECIMAL(20,4) NULL,
  high_qfq DECIMAL(20,4) NULL,
  low_hfq DECIMAL(20,4) NULL,
  low_qfq DECIMAL(20,4) NULL,
  pre_close_hfq DECIMAL(20,4) NULL,
  pre_close_qfq DECIMAL(20,4) NULL,
  macd_dif DECIMAL(12,6) NULL,
  macd_dea DECIMAL(12,6) NULL,
  macd DECIMAL(12,6) NULL,
  kdj_k DECIMAL(12,6) NULL,
  kdj_d DECIMAL(12,6) NULL,
  kdj_j DECIMAL(12,6) NULL,
  rsi_6 DECIMAL(12,6) NULL,
  rsi_12 DECIMAL(12,6) NULL,
  rsi_24 DECIMAL(12,6) NULL,
  boll_upper DECIMAL(20,4) NULL,
